...
const ServiceRow = (props) => {
  ...
  return (
    <div  className={styles.service_row}>
      ...
      <motion.span style={{cursor:'pointer'}} variants={plusAnimation} initial="initial" animate="animate"  onClick={()=>setDropDown(!dropDown)}><Unicons.UilPlus color='pink' size='40'/></motion.span>
        <AnimatePresence>
        {dropDown ? 
